...
const SignUp = () => {
  ...
  const handleSkipVerification = async () => {
    try {
      const res = await axios.post('/api/auth/skip-verification', { userId });
      ...
      toast.error(error.response?.data?.message || 'Failed to skip verification');
    }
  };

  return (
    <div className="max-w-md mx-auto">
      <h1 className="text-3xl font-bold text-center mb-8 text-text-primary">Sign Up</h1>
